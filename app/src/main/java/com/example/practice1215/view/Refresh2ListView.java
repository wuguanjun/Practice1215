 ...
 */
public class Refresh2ListView extends ListView implements AbsListView.OnScrollListener {
    ...
    public Refresh2ListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeaderView();
        initFooterView();
    ...
    private void initHeaderView() {
        headerView = View.inflate(getContext(), R.layout.pull_refresh_root, null);
        ivArrow = (ImageView) headerView
                .findViewById(R.id.img_refresh_icon);
        mProgressBar = (ProgressBar) headerView
                .findViewById(R.id.pb_refresh);
        tvState = (TextView) headerView
                .findViewById(R.id.tv_remain_refresh);
        tvLastUpdateTime = (TextView) headerView
                .findViewById(R.id.tv_current_refresh_time);
            ...
            case MotionEvent.ACTION_UP :
                ...
                if (currentState == RELEASE_REFRESH) {
                    ...
                    if (mOnRefershListener != null) {
                        mOnRefershListener.onRefresh(); // 调用使用者的监听方法
                    }
